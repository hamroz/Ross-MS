...
import core.model.InHousePart;
import core.model.Inventory;
import core.model.OutsourcedPart;
...
public class AddPartController implements Initializable {
    ...
    void handleCancelAddPart(ActionEvent event) throws IOException {
        ...
        if (outcome.get() == ButtonType.OK) {
            Parent addPartsScreen = FXMLLoader.load(getClass().getResource("../fxml/Main.fxml"));
    ...
    public void handleSaveAddPart(ActionEvent event) throws IOException {
        ...
        try {
            errorMsg = Part.isValidPart(nameTextField.getText(),
